...
const formTypeRouter = require('./routes/formType');
...
app.use('/lists', checkAuth, listRouter);
app.use('/organizations', checkAuth, organizationRouter);
...
app.use('/formTypes', checkAuth, formTypeRouter);
